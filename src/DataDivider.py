...
def prepare_cifar10():
    filenames = ['batches.meta', 'data_batch_1', 'data_batch_2', 'data_batch_3', 'data_batch_4', 'data_batch_5',
                 'test_batch']
    data_folder = '/root/autodl-tmp/datasets/cifar-10/'
...
def genrate_cifar10(pretrain=False,user_num=50,a=10):
    ...
    generator=DataDivider(data_list,label_list,num_users=user_num,a=a,division_ratio=[0, 0, 0, 0, 1,0],train_test_ratio=0.5,savepath='/root/autodl-tmp/fmaml/fmaml_mac/data/cifar10',num_class=10)
...
if __name__=='__main__':
    ...
    parser.add_argument('--dataset', default='cifar10', help='name of dataset;', type=str)
    ...
    if parsed['dataset']=='cifar10':
        ...
        genrate_cifar10(pretrain=False, user_num=50, a=50)
