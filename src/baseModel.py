...
class BaseModel(nn.Module):
    def __init__(self):
        ...
        #self.optimize()
        self.conv_1 = nn.Conv2d(3, 32, kernel_size=3, stride=1, padding='same', bias=True)
    ...
    # def backup_weights(self, backup_model):
    #     for self_param, backup_param in zip(self.parameters(), backup_model.parameters()):
    #             backup_param.data.deepcopy_(self_param)
